...
INSERT INTO Listing (Lsid, Lsdate, Lsdays_since_published, Lsprice, Lsprice_per_area, Lsfrom_who, Lsland_title_status, Lsdescription, Id)
VALUES (1149725899, '2024-01-22', 0, 655000, 5748629, 'From Owner', 'Condominium', 'SAHİBİNDEN KURULU MÜŞTERİLİ YAPILI GÜZELLİK MERKEZİ', 4);
...
try:
    ...
    cursor.execute(insert_into_tables_query, multi=True)

except mysql.connector.Error as err:
    print(f"Error: {err}")

finally:
    # Reset auto-commit mode to its default value (False)
